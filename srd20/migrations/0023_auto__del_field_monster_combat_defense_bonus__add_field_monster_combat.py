...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Monster.combat_maneuver_defense'
        db.add_column('srd20_monster', 'combat_maneuver_defense', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Monster.combat_defense_bonus'
        raise RuntimeError("Cannot reverse this migration. 'Monster.combat_defense_bonus' and its values cannot be restored.")

        # Deleting field 'Monster.combat_maneuver_defense'
        db.delete_column('srd20_monster', 'combat_maneuver_defense')
