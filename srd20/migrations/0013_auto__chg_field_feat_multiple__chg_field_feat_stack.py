...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feat.multiple'
        db.alter_column('feat', 'multiple', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Feat.stack'
        db.alter_column('feat', 'stack', self.gf('django.db.models.fields.BooleanField')())


    def backwards(self, orm):
        
        # Changing field 'Feat.multiple'
        db.alter_column('feat', 'multiple', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'Feat.stack'
        db.alter_column('feat', 'stack', self.gf('django.db.models.fields.CharField')(max_length=4))
