...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Spell.full_text'
        db.delete_column('spell', 'full_text')


    def backwards(self, orm):
        
        # Adding field 'Spell.full_text'
        db.add_column('spell', 'full_text', self.gf('django.db.models.fields.TextField')(default='No full text'), keep_default=False)
