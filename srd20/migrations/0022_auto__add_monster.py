...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('srd20_monster', (
            ...
            ('cr', self.gf('django.db.models.fields.IntegerField')()),
            ('xp', self.gf('django.db.models.fields.IntegerField')()),
            ('alignment', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('size', self.gf('django.db.models.fields.IntegerField')()),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('subtypes', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('other_type', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('class_level', self.gf('django.db.models.fields.CharField')(max_length=16, blank=True)),
            ('initiative', self.gf('django.db.models.fields.IntegerField')()),
            ('senses', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
            ('aura', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('armor_class', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('hit_points', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('fortitude_save', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('reflex_save', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('will_save', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('defensive_abilities', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('damage_reduction_amount', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('damage_reduction_condition', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ('immunities', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
            ('resistance', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('spell_resistance', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('weaknesses', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True)),
            ('speed', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('melee', self.gf('django.db.models.fields.CharField')(max_length=512, blank=True)),
            ('ranged', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('space', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2)),
            ('reach', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('special_attacks', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('spell_like_abilities', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('spells_known', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('sorcerer_spells_known', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('spells_prepared', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('opposition_schools', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ...
            ('base_attack_bonus', self.gf('django.db.models.fields.IntegerField')()),
            ('combat_maneuver_bonus', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('combat_defense_bonus', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('feats', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('skills', self.gf('django.db.models.fields.TextField')()),
            ('racial_modifiers', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ...
            ('gear', self.gf('django.db.models.fields.CharField')(max_length=128, blank=True)),
            ('environment', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('organization', self.gf('django.db.models.fields.TextField')()),
            ('treasure', self.gf('django.db.models.fields.TextField')(max_length=128)),
            ('abilities', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('reference', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('srd20', ['Monster'])


    def backwards(self, orm):
        
        # Deleting model 'Monster'
        db.delete_table('srd20_monster')
    ...
    models = {
        ...
        'srd20.monster': {
            ...
            'combat_defense_bonus': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            ...
            'treasure': ('django.db.models.fields.TextField', [], {'max_length': '128'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
