...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Spell.descriptor'
        db.alter_column('spell', 'descriptor', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Spell.components'
        db.alter_column('spell', 'components', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Feat.prerequisite'
        db.alter_column('feat', 'prerequisite', self.gf('django.db.models.fields.CharField')(max_length=1024))


    def backwards(self, orm):
        
        # Changing field 'Spell.descriptor'
        db.alter_column('spell', 'descriptor', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Spell.components'
        db.alter_column('spell', 'components', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'Feat.prerequisite'
        db.alter_column('feat', 'prerequisite', self.gf('django.db.models.fields.CharField')(max_length=512))
