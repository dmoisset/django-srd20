...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Monster.defensive_abilities'
        db.alter_column('srd20_monster', 'defensive_abilities', self.gf('django.db.models.fields.CharField')(max_length=512))

    def backwards(self, orm):

        # Changing field 'Monster.defensive_abilities'
        db.alter_column('srd20_monster', 'defensive_abilities', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        ...
        'srd20.monster': {
            ...
            'defensive_abilities': ('django.db.models.fields.CharField', [], {'max_length': '512', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
