...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Feat.altname'
        db.alter_column('feat', 'altname', self.gf('django.db.models.fields.SlugField')(default='', max_length=64))


    def backwards(self, orm):
        
        # Changing field 'Feat.altname'
        db.alter_column('feat', 'altname', self.gf('django.db.models.fields.SlugField')(max_length=64, null=True))
