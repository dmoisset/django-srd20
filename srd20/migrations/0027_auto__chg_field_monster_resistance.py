...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Monster.resistance'
        db.alter_column('srd20_monster', 'resistance', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Monster.resistance'
        db.alter_column('srd20_monster', 'resistance', self.gf('django.db.models.fields.CharField')(max_length=128))
