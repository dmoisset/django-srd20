...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Feat.full_text'
        db.delete_column('feat', 'full_text')


    def backwards(self, orm):
        
        # Adding field 'Feat.full_text'
        db.add_column('feat', 'full_text', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
