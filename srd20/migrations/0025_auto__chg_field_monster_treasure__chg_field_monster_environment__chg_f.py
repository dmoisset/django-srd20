...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Monster.treasure'
        db.alter_column('srd20_monster', 'treasure', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Monster.environment'
        db.alter_column('srd20_monster', 'environment', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Monster.armor_class'
        db.alter_column('srd20_monster', 'armor_class', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Monster.will_save'
        db.alter_column('srd20_monster', 'will_save', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Monster.ranged'
        db.alter_column('srd20_monster', 'ranged', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Monster.racial_modifiers'
        db.alter_column('srd20_monster', 'racial_modifiers', self.gf('django.db.models.fields.CharField')(max_length=512))

        # Changing field 'Monster.fortitude_save'
        db.alter_column('srd20_monster', 'fortitude_save', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Monster.treasure'
        db.alter_column('srd20_monster', 'treasure', self.gf('django.db.models.fields.TextField')(max_length=128))

        # Changing field 'Monster.environment'
        db.alter_column('srd20_monster', 'environment', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Monster.armor_class'
        db.alter_column('srd20_monster', 'armor_class', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Monster.will_save'
        db.alter_column('srd20_monster', 'will_save', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Monster.ranged'
        db.alter_column('srd20_monster', 'ranged', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Monster.racial_modifiers'
        db.alter_column('srd20_monster', 'racial_modifiers', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Monster.fortitude_save'
        db.alter_column('srd20_monster', 'fortitude_save', self.gf('django.db.models.fields.CharField')(max_length=128))
